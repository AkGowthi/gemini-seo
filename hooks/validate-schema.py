#!/usr/bin/env python3
"""Post-edit schema validation hook for the agent harness.
        ...
        "hooks": [
          {
            ...
            "command": "node",
            "args": [
              "${GEMINI_SEO_ROOT}/hooks/run-python-hook.js",
              "${GEMINI_SEO_ROOT}/hooks/validate-schema.py",
...
def _resolve_filepath():
    ...
    The agent harness's documented hook contract delivers the event as JSON on stdin;
