...
```
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run metadata_template.py --title "<title>" --description "<desc>" --json
```
...
```
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run metadata_template.py --pairs-file metadata.json --json
```
