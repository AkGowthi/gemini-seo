...
2. Use `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run render_page.py URL --mode auto --json
...
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run pagespeed_check.py URL --json
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run crux_history.py URL --json
```
