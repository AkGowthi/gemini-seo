...
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run capture_screenshot.py URL --all --output screenshots/
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run render_page.py URL --mode auto --a11y-tree --json
```
