...
- `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run drift_baseline.py <url>` -- capture a new baseline
- `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run drift_compare.py <url>` -- compare current state to baseline
- `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run drift_history.py <url>` -- show change history
- `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run drift_report.py <file> --output report.html` -- generate HTML report
