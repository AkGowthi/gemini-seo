...
`"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run parse_html.py` classifies each image's lazy-loading mechanism via the
...
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run iptc_ai_label.py audit ./images/ --json

# Audit a single image
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run iptc_ai_label.py audit ./hero.webp --json

# Inject the AI label into an image
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run iptc_ai_label.py inject ./ai-hero.webp \
