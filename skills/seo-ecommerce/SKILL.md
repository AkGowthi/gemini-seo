...
```
1. "${GEMINI_SEO_ROOT}/scripts/gemini-seo" run render_page.py <url> --mode auto → raw/rendered HTML
2. "${GEMINI_SEO_ROOT}/scripts/gemini-seo" run parse_html.py --url <url>   → SEO elements
...
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py log merchant_google_products_search <cost>
```
...
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_normalize.py results.json --module merchant
```
...
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py check merchant_amazon_products_search
```
...
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_merchant.py compare "<keyword>"
```
...
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run ucp_check.py https://store.example.com --json

# With endpoint reachability probes (HEAD each declared capability)
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run ucp_check.py https://store.example.com --probe-endpoints --json
```
