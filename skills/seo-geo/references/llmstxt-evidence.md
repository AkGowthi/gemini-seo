...
it as a Google ranking or citation lever in any gemini-seo report.
...
Continue, Cline, Gemini CLI-like agent harnesses) when loading per-library documentation.
...
## How gemini-seo treats `llms.txt`
...
- If the user asks to generate one, gemini-seo produces a minimal valid
