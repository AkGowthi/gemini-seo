...
Search ranking. Every gemini-seo audit that touches GEO should treat this doc
...
> gemini-seo's scores are heuristics, not Google-internal signals — state this
...
## How gemini-seo treats this guide
...
3. Where a third-party claim and Google contradict, gemini-seo defers to
