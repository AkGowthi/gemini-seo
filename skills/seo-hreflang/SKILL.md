...
- Machine-translated content with no meaningful human review (scaled content
  abuse per January 23, 2025 QRG §4.6.5). Load
  `references/machine-translation-qa.md` for the full flag list and checklist.
