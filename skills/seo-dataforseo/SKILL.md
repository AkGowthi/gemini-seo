...
```
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py check <endpoint> [--count N]
```
...
When DataForSEO MCP tools are available, other gemini-seo skills can leverage live data:
...
Match existing gemini-seo output patterns:
