...
Configure with: `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py config --mode threshold --threshold 0.50 --daily-limit 10.00`
...
1. Run `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py check <endpoint> [--count N]`
...
5. After call completes, log: `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run dataforseo_costs.py log <endpoint> <cost>`
