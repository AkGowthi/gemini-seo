...
## Experience (gemini-seo internal scoring weight: 20%)
...
## Expertise (gemini-seo internal scoring weight: 25%)
...
## Authoritativeness (gemini-seo internal scoring weight: 25%)
...
## Trustworthiness (gemini-seo internal scoring weight: 30%)
