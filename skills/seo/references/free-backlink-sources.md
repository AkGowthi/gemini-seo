...
This is enforced, not advisory: `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run validate_backlink_report.py` fails
...
- **Command:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run moz_api.py`
...
- **Command:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run bing_webmaster.py`
...
- **Command:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run commoncrawl_graph.py`
- **Cache:** `~/.cache/gemini-seo/commoncrawl/` (90-day TTL)
...
- **Command:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run verify_backlinks.py`
