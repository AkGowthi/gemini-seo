...
analysis (existing gemini-seo skills) and Google's real-time field data: actual
...
```bash
"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run google_auth.py --check --json
```

Config file: `~/.config/gemini-seo/google-api.json`
```json
{
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run pagespeed_check.py <url> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run pagespeed_check.py <url> --crux-only --json`

### `/seo google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run gsc_query.py --property <property> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run gsc_inspect.py <url> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run gsc_inspect.py --batch <file> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run indexing_notify.py <url> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run indexing_notify.py --batch <file> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run ga4_report.py --property <id> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run youtube_search.py search "<query>" --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run youtube_search.py video <video_id> --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
EU click-through impact diagnostic and DMA/Consent-Mode-v2 compliance framing
(behavioral-data restrictions since 2024-03-07).

**Reference:** `references/dma-consent-mode-v2.md`
...
**Script:** `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run pagespeed_check.py <url> --json > data.json`
3. Generate report: `"${GEMINI_SEO_ROOT}/scripts/gemini-seo" run google_report.py --type cwv-audit --data data.json --domain <domain>`
