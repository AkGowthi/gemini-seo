#!/usr/bin/env python3
"""
Normalize DataForSEO API responses for consistent consumption by gemini-seo skills.
...
def main():
    parser = argparse.ArgumentParser(
        description="Normalize DataForSEO API responses for gemini-seo skills"
    )
