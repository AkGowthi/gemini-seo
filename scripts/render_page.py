#!/usr/bin/env python3
"""
Shared headless renderer for gemini-seo.

Every analysis that fetches HTML for analysis (technical, content, schema,
...
Why
===
Before v2.0.0 only ``seo-visual`` used Playwright. Every other specialist
...
across all specialists" as the single highest-impact v2 change. This module
...
USER_AGENT = (
    ...
    "(KHTML, like Gecko) Chrome/150.0.7871.115 Safari/537.36 GeminiSEO/2.0"
)
...
def _cli() -> None:
    parser = argparse.ArgumentParser(
        description="gemini-seo shared headless renderer (Playwright + trafilatura)"
    )
