#!/usr/bin/env python3
"""
Moz Link Explorer API client for Gemini SEO.
...
RATE_LIMIT_DELAY = 10
RATE_LIMIT_FILE = os.path.expanduser("~/.cache/gemini-seo/moz_last_request.lock")
...
def main():
    parser = argparse.ArgumentParser(
        description="Moz Link Explorer API client for Gemini SEO"
    )
    parser.add_argument(
        "command",
