#!/usr/bin/env python3
"""
Backlink verification crawler for Gemini SEO.
...
def _head_check(url: str, timeout: int = 15) -> dict:
    ...
    try:
        resp = safe_requests_head(
            ...
            headers={"User-Agent": "GeminiSEO/1.8.0 BacklinkVerifier"},
        )
        return {
...
def main():
    parser = argparse.ArgumentParser(
        description="Backlink verification crawler for Gemini SEO"
    )
    parser.add_argument(
        "--target",
        required=True,
